...
from libs.utils.connector import MqttLocalClient
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Client has a few methods to get proxy to UA nodes that should always be in address space such as Root or
        # Objects
